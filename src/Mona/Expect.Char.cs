...
//         public static IParser<char> Char(Func<char, bool> predicate, string failureMessage)
//         {
//             failureMessage = failureMessage ??
//                 Strings.ErrorSinglePredicateFormat.Interpolate(
//                     Strings.SymbolTypeCharacter,
//                     Strings.PredicateUnspecified);
//             return Single(predicate: predicate, failureMessage: failureMessage);
//         }
...
//         /// <param name="predicate">A function to test each input symbol for a condition</param>
//         /// <returns>The parser.</returns>
//         public static IParser<char> Char(Func<char, bool> predicate)
//         {
...
//         /// <returns>The parser.</returns>
//         public static IParser<char> Char(char expected)
//         {
...
//         /// </summary>
//         /// <returns>The parser.</returns>
//         public static IParser<char> Char()
//         {
//             return Single(
