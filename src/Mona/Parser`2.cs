...
//     /// Composite parsers
//     /// </remarks>
//     /// <typeparam name="char">The type of the symbol in the input symbol</typeparam>
//     /// <typeparam name="TNode">The type of the resulting output</typeparam>
//     internal class Parser< TNode> : IParser<TNode>
//     {
//         readonly Func<IEnumerable<char>, IParse<TNode>> _Parse;
//         public Parser(Func<IEnumerable<char>, IParse<TNode>> parse)
//         {
//             if (parse == null)
//             {
